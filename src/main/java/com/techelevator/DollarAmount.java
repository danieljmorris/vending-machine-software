...
public class DollarAmount {
    ...
    public DollarAmount divide(DollarAmount amountToDivide){ 
        return new DollarAmount(this.totalAmountInCents / amountToDivide.totalAmountInCents);
    }
    
    public DollarAmount multiply(DollarAmount amountToMultiply) {
        return new DollarAmount(this.totalAmountInCents * amountToMultiply.totalAmountInCents);
    }
